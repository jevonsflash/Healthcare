...
namespace Healthcare.Server
{
    public class DiseaseServer
    {
        public IList<Model.DiseaseShowItem> DiseaseShowDeserializer(string jsonStr)
        {
            ...
            {
                diseaseShowItemModelList.Add(JTokenToModel(item));
            }
            return diseaseShowItemModelList;
        }
        public Model.DiseaseShowItem DiseaseObjectDeserializer(string jsonStr)
        {
        ...
        private DiseaseShowItem JTokenToModel(JToken item)
        {
